...
export default class Game extends Phaser.Scene {
    ...
    create() {
        ...
        platforms.create(300, 580, "ground").setScale(2).refreshBody();

        platforms.create(200, 280, "ground").setScale(1).refreshBody();

        platforms.create(500, 400, "ground").setScale(1).refreshBody();
